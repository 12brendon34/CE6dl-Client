...
class CGSSerializer {};
class IGSObject {};
class EPlatform { public: enum TYPE {}; };
...
class IUIManager {};
class IRoad {};
class Shapes { public: class IShapeMgr {}; };
class ISimpleObjects {};
class CTerrainType {};
class IUIEditorInterface {};
template<int, typename T, typename A> class listm {};
class ISGChunk {};
class IUIData {};
class MapId {};
class IAIDataManager {};
class IAIManager {};
class IPlayableAreaManager {};
class ITimeHandlerManager {};
class INavMeshManager {};
namespace Anim { class IPoseAnimatorManager {}; }
class CVarSet {};
class CGSObject {};
class IModelObject {};
