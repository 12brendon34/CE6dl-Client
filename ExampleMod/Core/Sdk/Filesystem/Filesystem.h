...
typedef void(__cdecl* LogPrintCallback)(enum Log::ELevel::TYPE, const char*, const char*);
LogPrintCallback __cdecl LogSetPrintCallback(LogPrintCallback newCallback);
